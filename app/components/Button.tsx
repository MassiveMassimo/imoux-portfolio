...
export default function Button({
  ...
  switch (type) {
    ...
    case "secondary":
      ...
      buttonTypeClasses[1] =
        "dark:bg-gradient-to-t from-base-100 to-base-200";
      buttonTypeClasses[2] =
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`${className} ${buttonTypeClasses[2]} inline-flex items-center justify-center gap-1 rounded-full bg-gradient-to-b px-4 font-medium`}
        >
          {children}
        </div>
      </div>
