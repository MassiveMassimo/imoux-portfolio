...
export default function Button({
  ...
  switch (type) {
    case "primary":
      buttonTypeClasses[0] =
        "from-indigo-200 dark:from-indigo-950 dark:to-indigo-950/0 to-indigo-300/0";
      buttonTypeClasses[1] = "from-indigo-500 to-indigo-600";
      buttonTypeClasses[2] = "from-indigo-600 to-indigo-500 text-indigo-100";
      break;
    case "secondary":
      buttonTypeClasses[0] = "from-base-200 to-base-100 dark:from-base-50/60";
