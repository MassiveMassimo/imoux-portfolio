...
export default function Hero() {
  return (
    <section className="grid h-screen grid-flow-col grid-cols-6 px-8 lg:px-16 pb-4 pt-20">
      <div className="highlight pointer-events-none z-10 col-span-4 col-start-2 row-span-2 row-start-1 flex -translate-x-1/3 flex-col justify-center space-y-2 rounded-3xl bg-slate-200/30 px-10 opacity-0 drop-shadow-2xl backdrop-blur-2xl transition delay-500 intersect:transform-none intersect:opacity-100 dark:bg-slate-800/60 lg:col-span-3 lg:col-start-1 lg:row-span-2 lg:row-start-2">
      ...
      <div className="relative col-span-6 col-start-1 row-span-6 row-start-2 translate-x-1/3 overflow-hidden rounded-3xl bg-[#7ABCDF] opacity-0 shadow-2xl transition delay-500 intersect:transform-none intersect:opacity-100 lg:col-span-4 lg:col-start-3 lg:row-span-4 lg:row-start-1">
        {/* <Loading /> */}
